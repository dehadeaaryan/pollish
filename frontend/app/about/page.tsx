    ...
    return (
        <motion.div
            ...
            <p className={subtitle({ class: "mt-6" })}>
                ...
                offers an interactive and quick way to gather everyone’s input instantly,
                making decision-making and brainstorming easy and fun. Start creating
                visual polls that engage your team or friends right away.
            </p>
        </motion.div>
    );
}
