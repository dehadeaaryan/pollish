...
import { HeartFilledIcon, HeartSlashIcon, SendIcon, UndoIcon } from "@/components/icons";
...
function PollishCard({ props, onLike, onDislike, cards, leftGlowOpacity, rightGlowOpacity }: PollishCardComponentProps) {
    ...
    return (
        <motion.div
            ...
            style={{
                gridRow: 1, gridColumn: 1, x, opacity, rotate, transition: "0.125s transform", boxShadow: isFront ? "0 20px 25px -5px rgb(0 0 0 / 0.5), 0 8px 10px -6px rgb(0 0 0 / 0.5)" : undefined,
            }}
            animate={{
        ...
        >
            ...
            >
                ...
                <CardFooter className="absolute bg-black/40 bottom-0 z-10 w-full flex justify-between items-center rounded-lg">
                    <Button radius="lg" size="sm" color="danger" onPress={() => onDislike(props.id)}>
                        <HeartSlashIcon />
                    </Button>
                    <Button radius="lg" size="sm" color="success" onPress={() => onLike(props.id)}>
                        <HeartFilledIcon />
                    </Button>
                </CardFooter>
            </Card>
...
export default function ViewPollishPage() {
    ...
    return (
        <div
            ...
            />
            <h1 className={title({ color: "yellow", size: "lg" }) + " capitalize z-40"}>{pollishName}</h1>
                    ...
                    >
                        <Card
                            ...
                            <CardBody className="grid place-items-center h-full">
                                <p className="text-center text-large font-medium">No more cards 🙁</p>
                            </CardBody>
                        </Card>
                    </motion.div>
                )}
            ...
            <div className="w-full flex justify-center items-center gap-2">
                ...
                <Button color="default" size="md" radius="lg" onPress={() => window.location.reload()}>
                    <UndoIcon />
                </Button>
                <Button color="primary" size="md" radius="lg" onPress={() => window.location.reload()}>
                    <SendIcon />
                </Button>
            </div>
        </div>
